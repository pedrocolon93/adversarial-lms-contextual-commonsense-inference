...
def roc_stories(data_dir, comet=False, kg_type='atomic',use_filter=True):
    ...
    print('done with val')
    return (train_stories, train_infs, train_mems, train_ids), (val_stories, val_infs, val_mems, val_ids) # stories are srcs, infs are targets, mems, ids are story ids
